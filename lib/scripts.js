...
/**
 * Statement identifying ol base (`var ol = {}`).
 * @type {Object}
 */
var olNode = {
...
/**
 * Statement with ol.provide call.
 * @type {Object}
 */
var provideNode = {
...
/**
 * Statement with ol.require call.
 * @type {Object}
 */
var requireNode = {
  type: 'ExpressionStatement',
...
/**
 * Get provides.
 * @return {Array.<string>} List of arguments to ol.provide calls.
 */
Script.prototype._getProvides = function() {
  ...
  var provides = this._ast.body.reduce(function(provides, statement) {
    ...
    } else if (like(statement, olNode)) {
      base = true;
    }
    return provides;
  }, []);
  // special handling for ol base
  if (base) {
...
/**
 * Get requires.
 * @return {Array.<string>} List of arguments to ol.require calls.
 */
