...
var Manager = exports.Manager = function Manager(options) {
  ...
  process.nextTick(function() {
    this._processPaths(paths, this._afterProcessPaths.bind(this));
  }.bind(this));
 ...
 */
Manager.prototype._afterProcessPaths = function(err) {
  if (err) {
...
Manager.prototype._addScript = function(script) {
  ...
  log.verbose('manager', 'Adding ' + name);
 ...
 */
Manager.prototype._processPaths = function(paths, done) {
  var self = this;
  async.waterfall([
    function(callback) {
